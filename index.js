...
client.on("guildMemberAdd", async (member) => {
  ...
  const welcomeEmbed = new Discord.MessageEmbed()
    ...
    .addFields(
      ...
      { name: "Server Rules", value: "<#1217017963182428200>.", inline: true }, // channel
      {
        name: "Support Channel",
        value: "<#1217321115295420426>.", // channel
        inline: true,
      },
    )
  ...
  const row = new MessageActionRow().addComponents(
    new MessageButton()
      .setStyle("LINK")
      .setURL("https://www.youtube.com/channel/UCvCt4OuwSdS4oDEpFEZ2xrA") // link to button 1
